...
const sectors = [
  {
    name: 'Healthcare',
    description:
      'Hospitals, clinics, and medical facilities with critical evacuation requirements.',
    icon: (
  ...
  },
  {
    name: 'Aged Care',
    description:
      'Residential aged care with vulnerable occupant considerations and strict regulations.',
    icon: (
  ...
  },
  {
    name: 'Government',
    description:
      'Public buildings, civic centres, and government offices with high foot traffic.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Office towers, mixed-use complexes, and multi-tenant commercial buildings.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2" /><path d="M9 22v-4h6v4" /><path d="M8 6h.01" /><path d="M16 6h.01" /><path d="M12 6h.01" /><path d="M12 10h.01" /><path d="M12 14h.01" /><path d="M16 10h.01" /><path d="M16 14h.01" /><path d="M8 10h.01" /><path d="M8 14h.01" /></svg>
    ),
  },
  {
    name: 'Retail',
    description:
      'Shopping centres and retail precincts with dynamic occupancy and public access.',
    icon: (
  ...
  },
  {
    name: 'Education',
    description:
      'Schools, universities, and campuses with complex multi-building layouts.',
    icon: (
...
export function SectorsSection() {
  ...
  return (
    <m.section
      ...
      animate={animate}
      className="flex w-full flex-col gap-6 py-8 md:gap-10 md:py-16 lg:py-20 xl:py-24"
    >
      ...
      <div className="mx-auto flex w-full max-w-5xl items-end justify-between gap-4 px-4 md:px-6 lg:px-8">
        ...
        <m.div variants={fadeUp} className="flex shrink-0 gap-2">
          <button
            onClick={scrollPrev}
